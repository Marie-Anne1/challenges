...
eplsymbl = Message(text = "=")
eplsymbl.place(x = 125, y = 30, width = 25, height = 25)
...
gender.set("M/F")
gendermenu = OptionMenu(windor, gender, "M", "F")
